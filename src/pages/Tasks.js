...
import TaskGeek from "../Components/Task/TaskGeek";
    ...
    const checkAllTasks = async () => {
      ...
      try {
        ...
        const [task1, task2, task3] = await Promise.all([
          ...
          checkTaskCompletion(id, TASK_IDS.GEEK),

          checkTaskCompletion(id, TASK_IDS.CORN)
    ...
    <Animate>
      ...
      <div className="flex-col justify-center w-full px-5 space-y-3">
        ...
        <TaskGeek
          ...
          showModal={modalStates.geek}

          setShowModal={(show) => toggleModal('geek')}

        />

        <TaskCorn

          showModal={modalStates.corn}

          setShowModal={(show) => toggleModal('corn')}
