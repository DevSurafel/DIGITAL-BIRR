...
const TaskCat = ({ showModal, setShowModal }) => {
  ...
  const taskID = "task_cat"; // Assign a unique ID to this task
  ...
  const handleTaskLinkClick = () => {
    window.open("http://t.me/catsgang_bot/join?startapp=m6FDxqNUj0SVCqFgKC441");
        ...
        <div className="fixed z-50 left-0 right-0 top-0 bottom-0 flex justify-center taskbg px-[16px] h-full">
          <div className={`w-full flex flex-col items-center justify-start`}>
            ...
            <div className="flex flex-col w-full">
              <h1 className="text-[20px] font-semibold">Play Cats</h1>
              <p className="text-[#9a96a6] text-[16px] font-medium pt-1 pb-10">
                Play Cats and earn future token
              </p>
