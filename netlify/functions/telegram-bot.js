...
bot.start((ctx) => {
  ...
  return ctx.replyWithMarkdown(`*Hey ${userName}, Welcome to Krypto!! Tap into the future of finance! Participate in challenges and watch your token balance soar!*
